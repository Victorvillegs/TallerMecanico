...
public class Trabajos implements ITrabajos {
    ...
    public void comenzar() {
        ...
        if(documentoXml != null) {
            ...
            System.out.printf("Fichero %s iniciado correctamente.%n", FICHERO_TRABAJOS);
        }
    }
    ...
    private Element getElemento(Document documentoXml, Trabajo trabajo) {
        ...
        elementoTrabajo.setAttribute(VEHICULO, trabajo.getVehiculo().matricula()); //setAttribute es para añadir un atributo
